...
//               }}
//               onClick={() =>
//                 handleAddItem(product._id, "6a07318a794ee2759c3da941")
//               }
//             >
//               Add To Cart
//             </button>

//             <button className="w-full border border-[#d0c5b5] py-4 text-xs tracking-[0.25em] text-[#1b1c1a] uppercase transition-all hover:bg-[#1b1c1a] hover:text-[#fbf9f6]">
//               Buy Now
//             </button>
//           </div>
//         </div>
